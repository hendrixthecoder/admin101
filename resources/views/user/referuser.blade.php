                    ...
                    <div class="card widget">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                <input type="disabled" class="form-control form-control-solid-bordered" value="{{ env('APP_URL') }}account/refer/{{ $user->referral_key }}" aria-label="{{ env('APP_URL') }}/account/refer/{{ $user->referral_key }}" aria-describedby="share-link1">
