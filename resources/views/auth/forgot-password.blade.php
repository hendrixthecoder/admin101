            ...
            <div class="container">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-center">
                                    Forgot your password? No worries type in your email here
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('password.email') }}" id="fpass" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <button type="submit" onclick="document.getElementById('fpass').submit();" class="btn btn-primary">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
