                            ...
                            <form action="{{ route('storeUser') }}" method="post" class="auth-credentials m-b-xxl" id="reg-form">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="email" value="{{ old('email') }}" type="email" class="form-control" id="settingsInputEmail" aria-describedby="settingsEmailHelp" placeholder="example@neptune.com">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="p_number" type="text" value="{{ old('p_number') }}" class="form-control" id="settingsPhoneNumber" placeholder="(xxx) xxx-xxxx">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col-md-6">
                                        <label for="settingsInputFirstName" class="form-label">First Name</label>
                                        <input name="f_name" value="{{ old('f_name') }}" type="text" class="form-control" id="settingsInputFirstName" placeholder="John">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="settingsInputLastName" class="form-label">Last Name</label>
                                        <input name="l_name" value="{{ old('l_name') }}" type="text" class="form-control" id="settingsInputLastName" placeholder="Doe">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input name="username" value="{{ old('username') }}" type="text" class="form-control" id="settingsInputUserName" aria-describedby="settingsInputUserName-add" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
